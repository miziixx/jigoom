...
const DEPTH_INSTRUCTION: Record<NonNullable<ReadingContext["depth"]>, string> = {
  ...
  advanced:
    "[고급 리딩] 표준 출력 형식을 모두 따르고, 반대 근거와 보완 방법을 특히 충실히 써라. '현실 조언' 섹션에 앞으로 1개월 행동 계획(주 단위 3~4개)을 추가해라.",
  expert:
    "[전문가 리딩] 표준 출력 형식을 모두 따르고, 다음을 추가해라: 계산값 인용을 최대로 하고, 해석 근거를 '강한 근거/보조 근거'로 계층화하고, 대운-세운-월운을 연결해서 시기를 해석하고, '현실 조언'에 3개월 실행 전략을 넣고, 마지막에 '이어서 물어보면 좋은 질문' 2~3개를 제안해라.",
};
