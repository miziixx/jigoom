...
오는지, (2) 관계·일·돈·건강 중 실제로 어디서 어떻게 드러나는지 장면이 그려지도록 구체적으로 쓴다.
'조언'은 1~2문장으로 오늘 확인할 신호나 이번 달 바로 할 수 있는 행동을 구체적으로 쓴다. 같은
표현이나 문장 리듬을 여러 달에 반복해 채우지 말고, 앞뒤 달과 비교했을 때 이 달이 왜 다른지가
드러나게 써라. 예:
3월 | 키워드: 관계의 미묘한 긴장 | 기회: 이번 달은 원국의 관계 자리와 새로 얽히는 흐름이 들어와 오래 미뤄둔 대화를 다시 꺼내기 좋은 시기입니다. 지난 몇 달보다 상대가 먼저 마음을 열 가능성도 높습니다. | 주의: 다만 사소한 말투 차이로 오해가 쌓이기 쉬우니, 피곤하거나 감정이 앞설 때는 대화를 다음 날로 미루는 편이 낫습니다. | 조언: 이번 달은 먼저 안부를 묻는 쪽이 되어 보고, 대화 전에 하고 싶은 말을 한 줄로 정리해 보세요
