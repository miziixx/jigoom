...
const DEFAULT_STANDARD_INSTRUCTION =
  ...
  "타고난 성격과 기질 / 직업과 돈 / 재물 흐름 / 애정과 관계 / 건강과 컨디션 / 인생의 큰 흐름 / 올해의 흐름 / " +
...
const DEPTH_INSTRUCTION: Record<NonNullable<ReadingContext["depth"]>, string> = {
  light:
    "[가벼운 리딩] 표준 출력 형식을 모두 따르되 절대 기본 영역을 생략하지 마라. 타고난 성격과 기질, 직업과 돈, 재물 흐름, 애정과 관계, 건강과 컨디션, 인생의 큰 흐름, 올해의 흐름을 모두 짧게라도 포함한다. 각 섹션은 핵심 판단과 바로 할 행동 중심으로 짧고 밀도 있게. 전체 공백 포함 2400~3200자.",
  basic:
