...
const DEFAULT_STANDARD_INSTRUCTION =
  ...
  "그리고 '# 올해의 흐름' 맨 끝에, 세일즈가 아니라 정보의 연장선처럼 딱 한 줄만 덧붙여라: \"구체적으로 어느 시기에 무엇을 해야 하는지는 고급 리딩에서 월 단위로 더 촘촘히 짚어드립니다.\" 재촉하거나 불안을 자극하는 톤은 절대 쓰지 말고, 이 한 줄 외에 결제를 권하는 문장을 반복하지 마라. " +
