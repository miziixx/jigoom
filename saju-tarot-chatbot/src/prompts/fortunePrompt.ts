...
7. 두루뭉술한 일반론을 절대 쓰지 않는다(가장 중요). do_actions·avoid_actions와 categories의 comment/good/caution은
   반드시 구체적 대상·상황·행동으로 쓴다. 어떤 걸 짚을지는 [근거 데이터]의 카테고리 점수·십성·지지 관계·신살·
   행운 아이템에서 골라야 하고, 근거값이 다르면 문장도 달라져야 한다. 남의 운세에 붙여도 말이 되는 문장이면 실패다.
   나쁜 예 → 좋은 예:
   - "무리하지 마세요" → "저녁 늦게 시작하는 논쟁이나 충동 결제는 하루 미루기"
   - "건강 챙기세요" → (근거의 오행·신살이 가리키는 부위로) "물 자주 마시고 밤샘 대신 11시 전에 눕기"
   - "금전운을 조심" → "오늘은 지인 돈거래·큰 지출 결정을 미루고, 살 거면 하루 자고 다시 보기"
   - "관계가 좋아요" → "미뤄둔 안부 연락 하나 먼저 보내기 좋은 날"
   단, 구체적으로 쓰되 공포·단정·중대 결정 유도는 여전히 금지한다. 짧아도 손에 잡히게 쓴다.
