...
const DEEP_QUESTION_SUGGESTIONS = [
  "관계 속마음을 더 깊게 봐줘. 반복되는 오해와 내가 조심할 반응을 알려줘.",
  "돈과 일 흐름을 더 자세히 봐줘. 돈이 붙는 방식과 새는 구멍을 알려줘.",
  "지금 피해야 할 선택을 더 깊게 봐줘. 현실적인 대안까지 알려줘.",
];
  ...
  return (
    <div className="card chat-followup">
      ...
      <p className="chat-followup__intro">
        속마음 리딩에서 본 관계·돈·일·선택 문제를 이어서 물어볼 수 있어요. “자세히”, “깊게”라고 물으면 답변이
        더 촘촘해집니다.
      </p>
