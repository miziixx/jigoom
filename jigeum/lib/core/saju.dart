...
// ---------------------------------------------------------------- 진태양시
/// 한국 주요 도시 경도(동경). 목록에 없으면 직접 입력.
const koreaCities = <(String, double)>[
  ('서울', 126.98), ('인천', 126.71), ('수원', 127.03), ('춘천', 127.73),
  ('강릉', 128.88), ('청주', 127.49), ('대전', 127.38), ('안동', 128.73),
  ('전주', 127.15), ('광주', 126.85), ('목포', 126.39), ('여수', 127.66),
  ('대구', 128.60), ('포항', 129.36), ('부산', 129.08), ('울산', 129.31),
  ('창원', 128.68), ('진주', 128.11), ('제주', 126.53), ('평양', 125.75),
];

const seoulLongitude = 126.98;
