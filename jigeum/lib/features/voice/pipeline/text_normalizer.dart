...
class TextNormalizer {
  ...
  static const List<List<String>> _typoFixes = [
    ['빠른대미', '빠른담기'], ['걸어노아', '걸어놔'], ['보류하메', '보류함에'],
    ['주문너음', '주문넣음'], ['출바람', '출발함'], ['습과으로', '습관으로'],
    ['자바주', '잡아주'], ['자바줘', '잡아줘'], ['저거놔', '적어놔'],
    ['저거줘', '적어줘'], ['저거놓', '적어놓'], ['지워조', '지워줘'],
    ['시자칸', '시작한'], ['다라줘', '달아줘'], ['내이 ', '내일 '],
    ['추카', '추가'], ['너어', '넣어'], ['너코', '넣고'], ['너음', '넣음'],
    ['해조', '해줘'], ['그팜', '급함'], ['그파', '급하'], ['임바', '임박'],
    ['핻어', '했어'], ['왇어', '왔어'], ['끈냈어', '끝냈어'], ['돗수', '도수'],
  ];
